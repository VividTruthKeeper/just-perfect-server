...
router.delete("/api/categories/delete/:id", adminAuth_1.adminAuth, [
    ...
    const { id } = req.params;
    const deletedCategory = yield (0, category_service_1.deleteCategory)(id);
    if (!deletedCategory)
        throw new generic_error_1.GenericError("Category not found", 404);
    res.status(200).send({
        status: "success",
